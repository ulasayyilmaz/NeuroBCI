...
import numpy as np
import pandas as pd
raw1 = mne.io.read_raw_brainvision('raw_data/SSS0007.vhdr', preload=True)
...
labels_df = pd.read_csv('testlabel.csv')
...
combined_data = labeled_data_run1 
...
print(out_df)
out_df.to_csv('labeledtestdata.csv')